...
final List<RecipeStep> borshSteps = [
  RecipeStep(waitTime: 90, id: 1, imgUrl: "assets/images/borsh1.jpg", description: "Налейте в кастрюлю холодную воду, выложите мясо и поставьте на средний огонь. Бульон будет вкуснее, если использовать именно мясо на кости."),
  RecipeStep(waitTime: 5, id: 2, imgUrl: "assets/images/borsh2.jpg", description: "Вымойте и почистите свёклу, морковь и лук. Свёклу натрите на крупной тёрке, а морковь — на средней. Лук нарежьте небольшими кубиками. Налейте масло в сковороду, включите средний огонь. Обжаривайте лук и морковь, помешивая, около 5 минут."),
  RecipeStep(waitTime: 7, id: 3, imgUrl: "assets/images/borsh3.jpg", description: "Затем выложите свёклу. Добавьте к ней лимонную кислоту, уксус или сок лимона. Благодаря этому борщ будет по-настоящему красным и приобретёт приятную кислинку. Готовьте зажарку ещё 5 минут. После этого добавьте томатную пасту, перемешайте и оставьте на огне ещё на 5–7 минут. Вместо томатной пасты можете добавить свежие, предварительно их нарезав мелкими кубиками, будет достаточно одного томата."),
  RecipeStep(waitTime: 10, id: 4, imgUrl: "assets/images/borsh4.jpg", description: "Когда бульон сварится, выньте из него мясо. Пока оно остывает, засыпьте в кастрюлю нашинкованную капусту. Через 5–10 минут добавьте нарезанный соломкой или кубиками картофель."),
  ...
  RecipeStep(waitTime: 10, id: 6, imgUrl: "assets/images/borsh6.jpg", description: "Для аромата можно добавить в кастрюлю немного измельчённого чеснока, молотой гвоздики или чёрного перца. Оставьте борщ под крышкой настаиваться 5–10 минут."),
];
...
final List<RecipeStep> sobaSteps = [
  ...
  RecipeStep(waitTime: 3, id: 2, imgUrl: "assets/images/soba2.jpg", description: "Налейте в кастрюлю воду, поставьте на средний огонь и доведите до кипения. Немного посолите и опустите лапшу целую, как спагетти, но если так не любите, можно поломать. После повторного закипания варите лапшу примерно 5-7 минут. Она должна быть немного не доваренная. "),
  RecipeStep(waitTime: 7, id: 3, imgUrl: "assets/images/soba3.jpg", description: "Куриное филе сполосните, обсушите и нарежьте крупной соломкой. В сковороду налейте масло и разогрейте на среднем огне. Добавьте в сковороду курицу и обжарьте в течение 5-7 минут. Снимите сковороду с огня и переложите курицу в чашку."),
  ...
  RecipeStep(waitTime: 5, id: 5, imgUrl: "assets/images/soba5.jpg", description: "Морковь почистите, вымойте и нарежьте соломкой средней длины и толщины. Добавьте морковь в сковороду с луком. Перемешайте и обжарьте, перемешивая, в течение 5 минут."),
  RecipeStep(waitTime: 3, id: 6, imgUrl: "assets/images/soba6.jpg", description: "Болгарский перец вымойте, удалите плодоножку с семенами и нарежьте средней соломкой. Добавьте в сковороду, с обжаренным овощами, перец и перемешайте. Обжарьте в течение 3 минут."),
  RecipeStep(id: 7, imgUrl: "assets/images/soba7.jpg", description: "Верните в сковороду обжаренную курицу и перемешайте."),
  RecipeStep(waitTime: 10, id: 8, imgUrl: "assets/images/soba8.jpg", description: "Помидор вымойте и вытрете, нарежьте на крупные дольки и добавьте в сковороду с овощами и курицей. Налейте воду и закройте крышкой, уменьшите огонь и готовьте еще 10 минут."),
  ...
  RecipeStep(waitTime: 2, id: 12, imgUrl: "assets/images/soba12.jpg", description: "Прогрейте лапшу с овощами и курицей на среднем огне в течение 1-2 минут, снимите с огня."),
